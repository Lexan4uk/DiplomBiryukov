...
const BoquetMain = () => {
	...
	} = useSWR(apiTags.getBoquetCompleted, simpleGet)

	return (
		<div className='main-catalog__boquet-holder f-column gap-10'>
			<h1 className='main-catalog__page-title title-l'>Выбор букета</h1>
			<p className='main-catalog__page-desc text-l'>
				На этой странице вы сможете выбрать готовый букет, созданный лучшими
				флористами. Каждый букет - это сочетание утончённых цветов, идеально
				подобранных по цветовой гамме и стилю. Оцените разнообразие предложений:
				от классических роз до необычных авторских композиций. Сделайте выбор,
				который подчеркнет особенный момент или станет идеальным подарком.
			</p>
